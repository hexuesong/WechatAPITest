...
![img](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==) ![img](https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIO6jib8XP3r8h8sib080icibHvumUWHk7VVBq5O5WgWj1QFQBPWljlj5CibsUx6fp4b7LQhvNJmGN6v73A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
...
Ribbon主要提供客户侧的软件负载均衡算法。Ribbon客户端组件提供一系列完善的配置选项，比如连接超时、重试、重试算法等。Ribbon内置可插拔、可定制的负载均衡组件。
...
![img](https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIOvqXXzXPicacuC197UIKZfM3BiapgtPw2oOJz7kDWMdTKicbTCcLsunQtIDoRwWDBdZTUckm8WZ8kHg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
有的区域随着虚拟机进程的启动而存在，有的区域则依赖用户进程的启动和结束而创建和销毁。
 ...
 ![img](https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIPZAzOTEq0Uds38t1AIc0XWGJp9eRCibzdb8QibHBVibg5mAgP7XAWXq8tCxhQ14WN6mPKSBNzZHFBYg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1) 
